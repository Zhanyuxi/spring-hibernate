            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="post" id="updateform" action="/storage_order/save">
                            <P style="position: relative;">
                                <span class="p_logo"></span>
                                <input class="ipt" id="productName" type="text" name="productName" placeholder="请输入产品名"/>
                            </P>
                            <P style="position: relative;">
                                <span class="p_logo"></span>
                    ...
                    <a style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" href="javascript:;" onclick="submitForm()">新增入库单</a>
                </span>
                            </div>
                        </form>
                        <!-- /.table-responsive -->
